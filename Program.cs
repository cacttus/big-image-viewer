...
namespace Oc
{
    class Program
    {
        ...
        public static void Main()
        {
            ...
            Application.Run(new Oc.MainForm());
        }
        void CreateTestWindow()
        {

            GameWindow _mainWindow;
            //BaseCamera _mainCamera;

            _mainWindow = new GameWindow();

            _mainWindow.Load += (sender, e) =>
            {
                // setup settings, load textures, sounds
                _mainWindow.VSync = VSyncMode.On;
            };

            _mainWindow.Resize += (sender, e) =>
            {
            ...
            _mainWindow.UpdateFrame += (sender, e) =>
            {
                ...
                //if(_mainWindow.Keyboard[Key.Escape])
                //{
                //    _mainWindow.Exit();
                //}
                //if (_mainWindow.Keyboard[Key.Down])
                //{
